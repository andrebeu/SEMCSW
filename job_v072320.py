...
def main(n_epochs=28, batch_size=25,lr=0.001,log_alpha=0.0,
    ...
    :param var_df0      float   (None)  prior variance df
    :param var_scale0   float   (None)  prior variance scale 
    ...
    json_tag = '_{}_nhidden{}_e{}_lr{}_n{}_d{}_logalfa_{}_loglmda_{}_df_{}_scale_{}_batch_{}{}'.format(
        model, n_hidden, epsilon, lr, n_epochs, dropout, log_alpha, log_lambda, var_df0, var_scale0,
         batch_n, tag)
