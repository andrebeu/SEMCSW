"""Schema Prediction, Andre's version, 10/22/20

This version includes instructions as a seperate feature (dimension) on the 
scene embeddings
...
def generate_exp(condition, seed=None, err=0.1, n_train=160, n_test=40, embedding_library=None, 
                    actor_weight=1.0, use_instructions=False):
    """
