...
def main():
    ...
    def run_single_batch(epsilon, lr, n_epochs, dropout):
    ...
    dropouts = [0.0]
    lrs = [0.0002, 0.0005, 0.001, 0.002, 0.004, 0.008, 0.01, 0.02]
    n_epochs_list = [4, 6, 8, 10, 12, 14, 16, 18, 20]
    ...
    for batch_n in range(n_batch):
        ...
        for epsilon, lr, n_epochs, dropout in np.random.permutation(parameter_tuples):
            run_single_batch(epsilon, lr, n_epochs, dropout)
